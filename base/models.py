...
class Room(models.Model):  #creating a class
    ...
    updated= models.DateTimeField(auto_now=True)      # every time updated time stamp created
    created= models.DateTimeField(auto_now_add=True)  # when created time stamp taken
